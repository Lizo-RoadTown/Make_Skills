...
Flow:
  1. Call core.skill_making.compiler.compile_from_bridge_candidate
  ...
  4. Call services.skill_making.ack_sender.send_registration_ack
...
from core.skill_making.compiler import (
    CompiledSkillResult,
